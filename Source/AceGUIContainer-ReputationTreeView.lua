--[[-----------------------------------------------------------------------------
Reputation Tree View
Based on Ace3 TreeGroup Container
-------------------------------------------------------------------------------]]
...
local function Constructor()
	...
	local scrollbar = CreateFrame("Slider", ("AceReputationTreeView%dScrollBar"):format(num), treeframe, "UIPanelScrollBarTemplate")
