...
L["Controls whether bars are visible or not.\nYou can toggle this from the console using |cffeda55f/rptb StaticBars2 visible|r."] = true
...
L["The StaticBars2 module shows the reputation for the factions that you specify."] = true
